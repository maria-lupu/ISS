...
public class MainClass extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        CartRepository cartRepo = new CartRepository(connectionProvider, bookRepository);
        OrderRepository orderRepo = new OrderRepository(connectionProvider, bookRepository);
        Service service = new Service(userRepository, bookRepository, cartRepo,  orderRepo);
